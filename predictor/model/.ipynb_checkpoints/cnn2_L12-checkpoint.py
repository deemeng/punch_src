...
class Net(nn.Module):
    def __init__(self, in_features, dropout=0.25):
        ...
        self.conv9 = nn.Conv1d(self.conv8.out_channels, 20, kernel_size=7, stride=1, padding=3)
        ...
        self.conv12 = nn.Conv1d(self.conv11.out_channels, 1, kernel_size=1, stride=1, padding=0)
