...
from utils.embedding import save_embedded
...
# embed and save
list_idrDataset_smoothed = read_json2list(paramsPDB.path_IDRdataset_smoothed)

list_seq = []
list_id = []
        
for dict_idr in list_idrDataset_smoothed:
